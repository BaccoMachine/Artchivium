...
const BackgroundLayer = ({ variant = "studio" }) => (
    ...
    <header className="topbar">
      ...
      <div className="tb-right">
        ...
        <button className="tb-user">
          <span className="tb-user-dot">C</span>
          <span className="tb-user-name">Chiara B.</span>
        </button>
      </div>
    </header>
  );
...
Object.assign(window, { BackgroundLayer, Topbar, ConvPanel, BG_PRESETS });
